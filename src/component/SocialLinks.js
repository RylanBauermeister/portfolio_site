...
const SocialLinks = (props) => {
    return <div className="social-links">
      <a href="https://www.facebook.com/rylan.bauermeister" target="blank"><Button circular color='facebook' icon='facebook' /></a>
      <a href="https://twitter.com/RylanBauermeis1" target="blank"><Button circular color='twitter' icon='twitter' /></a>
